...
class Email {
    ...
    public function enviarConfirmacion() {
        ...
        try {
            ...
            $mail->SMTPAuth   = true;
            $mail->Username   = 'zt230111941@zapotlanejo.tecmm.edu.mx';  //es tu  gmail institucional de preferencia
            $mail->Password   = 'oyve iciv tvjj cwyv';  //esta la obtienes en la configuración du gmail
            $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
            $mail->Port       = 587;

            $mail->setFrom('zt230111941@zapotlanejo.tecmm.edu.mx', 'app_salon');
    ...
    try {
        ...
        $mail->Host = 'smtp.gmail.com';
        $mail->SMTPAuth = true;
        $mail->Username = 'zt230111941@zapotlanejo.tecmm.edu.mx';
        $mail->Password = 'oyve iciv tvjj cwyv';
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
        $mail->Port = 587;
